    ...
    $('#submitWeather').click(function () {
        ...
        if (city != '') {
            ...
            $.ajax({
                ...
                url: "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric" + "&appid=de0beaf5a28fc57eed081e333502c625",
                type: "GET",
                dataType: "jsonp",
...
function show(data) {
    return "<h2>Current Weather for " + data.name +"," + data.sys.country +"</h2>" +
           ...
           "<h3><strong>Max Temperature</strong>: " + data.main.tem_max + "</h3>" +
           "<h3><strong>Wind Direction</strong>: " + data.wind.speed +"</h3>";
